...
function SideBarOwners() {
  ...
  return (
    <section className="w-full lg:w-fit h-fit md:sticky top-5">
      <div className="flex flex-col items-start w-full lg:w-[292px] lg:h-fit lg:rounded-2xl bg-ps-white lg:shadow-md max-sm:overflow-x-scroll lg:overflow-hidden z-50">
          ...
          <button
            ...
            className={`flex gap-5 ${
              accountState === "changepassword"
                ? "bg-ps-orange-100 text-ps-orange-500"
                : "text-ps-gray-500"
            }  py-[20px] px-[20px] mb-5 hover:text-ps-orange-500 `}
          >
            <Image
              className="w-[25px] h-[24px] hover:text-ps-orange-500"
              src={
