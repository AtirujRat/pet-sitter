  ...
  return (
    <div className="w-full h-full bg-ps-gray-100 lg:pt-10 lg:pb-20">
      <div className="max-w-[1440px] min-w-0 lg:flex lg:justify-between mx-auto max-lg:flex-col lg:items-start lg:px-20  gap-9">
        <SideBarOwners />
        <div className="w-full lg:w-[965px] bg-ps-white min-h-[824px] shadow-md lg:rounded-2xl p-[10px] lg:p-[40px] flex flex-col items-start gap-[40px] lg:gap-[45px]">
          ...
          {loading ? (
            ...
            <>
              {bookingList.length > 0 ? (
                          ...
                          <div className="flex items-center gap-[16px] ">
                            ...
                            <div className="w-[80%]">
                              <h1 className="text-h3">
                                {item.sitters.trade_name}
                              </h1>
                              <h1 className="text-b1">
                                By {item.sitters.full_name}
                              </h1>
                            </div>
                          </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-[10px] sm:gap-[15px] justify-between mt-[16px] ">
                          <div className="w-full md:w-[55%] ">
                            ...
                            <div className="flex items-center gap-[12px]">
                              ...
                              <span className="text-b2 text-ps-gray-400">
                                |
                              </span>
                              <span className="text-b3 2xl:text-b2 text-ps-gray-600">
                          ...
                          {item.status === "Success" ? (
                            <div>
                              ...
                              <h1 className={`flex gap-[10px]`}>
                                <span
                                  className={`text-${BOOKING_STATUS.Success}`}
                                >
                ...
                <p className="text-b1 text-ps-gray-400">
